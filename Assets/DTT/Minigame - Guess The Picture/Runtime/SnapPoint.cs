...
{    
    /// <summary>
     /// Handles snapping an <see cref="GuessLetter"/> to a snapping point.
     /// </summary>
    public class SnapPoint : MonoBehaviour
    {
        ...
        /// </summary>
        public event Action<GuessLetter> RemovedLetter;

        /// <summary>
        /// Current letter this snap point is holding.
        /// </summary>
        public GuessLetter CurrentLetter { get; private set; }
        ...
        internal void SetLetter(GuessLetter letter)
        {
            GuessLetter oldLetter = CurrentLetter;
            ...
            CurrentLetter.LastSnapPoint = this;
        ...
        /// </summary>
        /// <param name="letter">Letter to be snapped.</param>
        public void SnapLetter(GuessLetter letter)
        {
            SetLetter(letter);
        ...
        private void UnsnapLetter(GuessLetter letter)
        {
